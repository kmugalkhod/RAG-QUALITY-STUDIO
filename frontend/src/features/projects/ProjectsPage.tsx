...
export function ProjectsPage() {
  ...
  return <>
    <div className="page-heading"><div><h1>Projects</h1><p>A place to build a better answer.</p></div><Button ref={newButton} onClick={() => { setShowForm(true); setNotice(''); }} disabled={showForm}><Plus size={17}/>New project</Button></div>
    <p className="page-intro">Organize your RAG work into projects. Open a project to upload documents and inspect processed chunks.</p>
