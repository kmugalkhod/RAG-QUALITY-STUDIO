...
import { RunResult } from './Playground';
...
describe('query result', () => {
  it('renders source buttons only for supplied labels and flags invalid references', () => {
  ...
  it('shows failed runs and preserved evidence', () => {
    render(<RunResult run={{ ...run, status: 'failed', answer: null, error: 'OpenRouter timed out.' }}/>);
